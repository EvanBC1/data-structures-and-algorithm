...
alphabetizeBetter(['alphabet', 'Zebra', 'Alphabet', 'carrot']);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
sortNumbersByLength(['challenge 6', 10, 2.8, 1, -47.75]);
/*-----------------------------------------------------------------------------------------------
CHALLENGE 7
...
const sortPeopleBetter = (arr) => {
  console.log('challenge 8', arr);
  arr.sort((a,b)=> a.lastName.localeCompare(b.lastName));
  
  // if (arr.sort((a,b) => a.lastName.localeCompare(b.lastName) === 0)) {
  //   arr.sort((a,b)=> a.firstName.localeCompare(b.firstName));
  //   console.log(arr);
  // }
  
  // if (arr.sort((a,b) => a.lastName.localeCompare(b.lastName) === 0)) {
  //   arr.sort((a,b)=> String(a.age).localeCompare(String(b.age)));
  //   console.log(arr);
  }
  console.log('challenge 8', arr);
  return(arr);
