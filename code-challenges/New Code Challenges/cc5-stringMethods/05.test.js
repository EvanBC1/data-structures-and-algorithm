...
const listFoods = (recipe) => {
  ...
  for (let i = 0; i < recipe.ingredients.length; i++){
    ...
    slicePoint = ingredient.indexOf(' ')
    ingredient = ingredient.slice(slicePoint + 1, ingredient.length);
    
    ingredient2 = ingredient
    slicePoint2 = ingredient2.indexOf(' ')
    ingredient2 = ingredient.slice(slicePoint2 + 1, ingredient2.length);
...
const splitFoods = (recipe) => {
  ...
  for (let i = 0; i < recipe.ingredients.length; i++){
    ...
    let ingredient2 = ingredient.join(' ');
    ingredient2
    result.push(ingredient2)
  }
  console.log(result);
...
removeEvenValues([6, 3, 19, 43, 12, 66, 43]);
